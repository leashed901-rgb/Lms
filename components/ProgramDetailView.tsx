          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              <div className="flex flex-wrap items-center gap-2.5">
                <span className="inline-flex items-center px-2.5 py-1 rounded-sm bg-white/10 border border-white/15 text-xs font-mono font-semibold uppercase tracking-wider text-[#eed8b8]">
                  {program.badge} · CODE: {program.code}
                </span>
                <span className="text-xs px-2.5 py-1 rounded-sm bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 font-mono font-medium">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <button
                  ...
                  className="px-6 py-3 rounded-md bg-[#ecd2af] hover:bg-[#f3dfc3] text-[#141b16] font-bold text-xs tracking-wide transition-all flex items-center gap-2"
                >
                ...
                <Link
                  href="/classroom"
                  className="px-5 py-3 rounded-md bg-white/10 hover:bg-white/20 text-white font-semibold text-xs tracking-wide transition-all border border-white/20 flex items-center gap-2"
                >
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-[4/3] w-full rounded-lg overflow-hidden border border-white/15">
                <Image
                ...
                />
                <div className="absolute top-3 right-3 px-2.5 py-1 rounded-sm bg-black/75 text-white font-mono text-[0.68rem] font-bold tracking-wider uppercase">
      ...
      <div className="w-full max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <main className="w-full lg:flex-1 min-w-0">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-10">
                ...
                <section className="bg-white p-6 sm:p-8 rounded-lg border border-[#e2ddd4]">
                  ...
                  <div className="text-[#3c4a3e] leading-relaxed space-y-4 text-sm sm:text-base mb-6">
                    ...
                    {syllabus && (
                      <div className="p-4 rounded-md bg-[#f4f1eb] border border-[#e2ddd4] text-xs sm:text-sm text-[#243328] font-mono leading-relaxed">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {program.coreCompetencies.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-3 p-3.5 rounded-md bg-[#fbf9f5] border border-[#e2ddd4] text-[#141b16] text-xs sm:text-sm font-medium"
                      >
                ...
                <section className="bg-white p-6 sm:p-8 rounded-lg border border-[#e2ddd4]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    {/* SVG Donut Chart */}
                    <div className="md:col-span-4 flex flex-col items-center justify-center p-4 bg-[#fbf9f5] rounded-lg border border-[#e2ddd4]">
                    ...
                    <div className="md:col-span-8 space-y-4">
                      {program.breakdown.map((item, idx) => (
                        <div key={idx} className="p-4 rounded-md bg-[#fbf9f5] border border-[#e2ddd4]">
                          <div className="flex items-center justify-between mb-1.5">
                            ...
                            <span className="text-xs font-mono font-bold text-[#1b3d2b] bg-white px-2 py-0.5 rounded-sm border border-[#e2ddd4]">
                ...
                <section className="bg-white p-6 sm:p-8 rounded-lg border border-[#e2ddd4]">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs font-mono px-2.5 py-1 bg-[#1b3d2b]/10 text-[#1b3d2b] rounded-sm font-semibold">
                      Mon – Fri | 08:00 – 15:30
                    </span>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="p-4 rounded-md bg-[#1b3d2b]/5 border border-[#1b3d2b]/20">
                    ...
                    <div className="p-4 rounded-md bg-[#d9b589]/10 border border-[#d9b589]/30">
                    ...
                    <div className="p-4 rounded-md bg-[#0d9488]/5 border border-[#0d9488]/20">
            ...
            {activeTab === 'curriculum' && (
              <div className="space-y-6">
                {/* View Mode Switcher */}
                <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-white rounded-lg border border-[#e2ddd4]">
                  <div>
                  ...
                  <div className="inline-flex rounded-md bg-[#f4f1eb] p-1 border border-[#e2ddd4]">
                    <button
                  ...
                  <div className="space-y-4">
                    {program.terms.map((term, index) => {
                      ...
                      return (
                        <div
                          key={term.termNumber}
                          className="bg-white rounded-lg border border-[#e2ddd4] overflow-hidden transition-all"
                        >
                          <button
                            onClick={() => setOpenTermIndex(isOpen ? null : index)}
                            className="w-full text-left p-5 flex items-start sm:items-center justify-between gap-4 hover:bg-[#fbf9f5] transition-colors"
                          >
                            <div className="flex items-start sm:items-center gap-4">
                              <div className="w-11 h-11 rounded-md bg-[#1b3d2b]/10 border border-[#1b3d2b]/20 flex flex-col items-center justify-center shrink-0">
                                <span className="text-[9px] font-bold text-[#1b3d2b] uppercase">TERM</span>
                                <span className="text-sm font-bold font-serif text-[#1b3d2b]">{term.termNumber}</span>
                              </div>
                              <div>
                            ...
                            <ChevronDown
                              className={`w-4 h-4 text-[#617466] transition-transform duration-200 shrink-0 ${
                                isOpen ? 'rotate-180' : ''
                              }`}
                            />
                          </button>
                          ...
                          {isOpen && (
                            <div className="p-5 pt-0 border-t border-[#e2ddd4]/70 bg-[#fbf9f5]/40 space-y-5">
                              <p className="text-sm text-[#3c4a3e] leading-relaxed pt-4">{term.description}</p>

                              {/* Clock Hour Allocation Bar */}
                              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-3.5 rounded-md bg-white border border-[#e2ddd4]">
                                <div>
                              ...
                              <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                  {term.courseHighlights.map((mod) => (
                                    <div
                                      key={mod.code}
                                      className="p-4 rounded-md bg-white border border-[#e2ddd4] hover:border-[#1b3d2b]/40 transition-colors"
                                    >
                                      <div className="flex items-center justify-between mb-1.5">
                                        <span className="font-mono text-xs font-bold text-[#1b3d2b] px-2 py-0.5 rounded-sm bg-[#1b3d2b]/10">
                                          {mod.code}
                                        </span>
                ...
                {curriculumViewMode === 'weekly' && (
                  <div className="bg-white rounded-lg border border-[#e2ddd4] p-5">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                      ...
                      <span className="text-xs font-mono font-bold px-2.5 py-1 rounded-sm bg-[#1b3d2b]/10 text-[#1b3d2b]">
                ...
                {curriculumViewMode === 'catalog' && (
                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg border border-[#e2ddd4] flex items-center justify-between">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {programCatalogModules.map((m) => (
                        <div key={m.code} className="p-5 rounded-lg bg-white border border-[#e2ddd4] flex flex-col justify-between">
                          <div>
                            <div className="flex items-center justify-between gap-2 mb-2">
                              <span className="font-mono text-xs font-bold px-2 py-0.5 rounded-sm bg-[#1b3d2b]/10 text-[#1b3d2b]">
                                {m.code}
                              </span>
                              <div className="flex items-center gap-1.5">
                                <span className="text-xs font-medium text-[#617466]">{m.hours} Clock Hrs</span>
                                <span className="text-[10px] px-1.5 py-0.5 rounded-sm bg-[#f4f1eb] font-semibold text-[#617466]">
                                  {m.level}
                                </span>
                              </div>
                            </div>
                ...
                <section className="bg-white p-6 sm:p-8 rounded-lg border border-[#e2ddd4]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {syllabus?.careerOutcomes.map((outcome, idx) => (
                      <div key={idx} className="p-5 rounded-lg bg-[#fbf9f5] border border-[#e2ddd4] flex flex-col justify-between">
                        <div>
                          <span className="text-[10px] font-bold px-2 py-0.5 rounded-sm bg-[#1b3d2b]/10 text-[#1b3d2b] uppercase tracking-wider block w-fit mb-2">
                ...
                <section className="bg-white p-6 sm:p-8 rounded-lg border border-[#e2ddd4]">
                  ...
                  <div className="space-y-4">
                    {syllabus?.rubricDomains.map((r, idx) => (
                      <div key={idx} className="p-4 rounded-lg border border-[#e2ddd4] bg-[#fbf9f5]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                          <div className="p-3 rounded-md bg-white border border-[#e2ddd4]">
            ...
            {activeTab === 'requirements' && (
              <div className="space-y-6">
                ...
                <section className="bg-white p-6 sm:p-8 rounded-lg border border-[#dc2626]/30">
                  ...
                  <div className="space-y-3">
                    {syllabus?.safetyGates.map((gate) => (
                      <div key={gate.code} className="p-4 rounded-md bg-[#fef2f2] border border-[#fecaca] flex items-start gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-[10px] px-2 py-0.5 rounded-sm bg-[#fee2e2] text-[#991b1b] font-bold">
                              {gate.stage}
                            </span>
                          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <section className="bg-white p-6 rounded-lg border border-[#e2ddd4]">
                  ...
                  <section className="bg-white p-6 rounded-lg border border-[#e2ddd4]">
                    ...
                    <div className="p-3 rounded-md bg-[#f4f1eb] text-xs font-mono text-[#1b3d2b] font-semibold">
            ...
            {activeTab === 'faq' && (
              <section className="bg-white p-6 sm:p-8 rounded-lg border border-[#e2ddd4] space-y-4">
                <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#1b3d2b] mb-2">
                ...
                <div className="space-y-3">
                  {syllabus?.faqs.map((faq, idx) => {
                    ...
                    return (
                      <div key={idx} className="border border-[#e2ddd4] rounded-md overflow-hidden">
                        <button
          ...
          <aside className="w-full lg:w-80 shrink-0 space-y-6">
            <div className="bg-white rounded-lg border border-[#e2ddd4] p-6">
              ...
              <button
                onClick={() => setEnrollModalOpen(true)}
                className="w-full py-3 px-4 rounded-md bg-[#1b3d2b] text-white text-sm font-semibold hover:bg-[#2d5a3f] transition-colors flex items-center justify-center gap-2 mb-3"
              >
              ...
              <Link
                href={`/classroom`}
                className="w-full py-2.5 px-4 rounded-md bg-[#f4f1eb] text-[#1b3d2b] border border-[#e2ddd4] text-xs font-semibold hover:bg-[#e8e2d8] transition-colors flex items-center justify-center gap-2"
              >
            ...
            {syllabus && (
              <div className="bg-[#1b3d2b] text-white rounded-lg p-6">
